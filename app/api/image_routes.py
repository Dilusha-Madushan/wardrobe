...
get_all_images_parser.add_argument('per_page', type=int, required=False, choices=[10, 20, 50], default=10, help="Images per page")
...
image_info_model = image_ns.model('ImageInfoModel', {
    'category': fields.String(description="Image category"),
